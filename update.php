...
$sql=mysqli_query($con,"update tblusers set
FirstName='$fname',LastName='$lname',EmailId='$emailid',ContactNumber='$contactno',
Address='$address' where id='$rid'");
;
...
<div class="row">
<div class="col-md-12">
<h3>Update Record | Garment factory Management System</h3>
<hr />
</div>
</div>
<?php
...
$sql =mysqli_query($con, "select * from tblusers where id=('$userid')");
