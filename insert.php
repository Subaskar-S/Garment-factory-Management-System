...
$sql=mysqli_query($con,"insert into tblusers(FirstName,LastName,EmailId,ContactNumber,Address)
value('$fname','$lname','$emailid','$contactno','$address')");
if($sql)
{
...
<div class="row">
<div class="col-md-12">
<h3>Insert Record | Garment factory Management System</h3>
<hr />
</div>
</div>
